...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"codchen", "newchainpoc", "dex", "params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_LongBook_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"codchen", "newchainpoc", "dex", "long_book", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_LongBookAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"codchen", "newchainpoc", "dex", "long_book"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_ShortBook_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"codchen", "newchainpoc", "dex", "short_book", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_ShortBookAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"codchen", "newchainpoc", "dex", "short_book"}, "", runtime.AssumeColonVerbOpt(true)))
)
