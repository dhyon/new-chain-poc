...
export class Api extends HttpClient {
    constructor() {
         ...
         */
        this.queryLongBookAll = (query, params = {}) => this.request({
         ...
         */
        this.queryLongBook = (id, params = {}) => this.request({
         ...
         */
        this.queryShortBookAll = (query, params = {}) => this.request({
         ...
         */
        this.queryShortBook = (id, params = {}) => this.request({
