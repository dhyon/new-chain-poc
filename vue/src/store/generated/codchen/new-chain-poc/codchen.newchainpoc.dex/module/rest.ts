...
export type DexMsgLimitBuyResponse = object;

export type DexMsgLimitSellResponse = object;

export type DexMsgMarketBuyResponse = object;

export type DexMsgMarketSellResponse = object;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  queryLongBookAll = (
    ...
    this.request<DexQueryAllLongBookResponse, RpcStatus>({
      path: `/codchen/newchainpoc/dex/long_book`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   */
  queryLongBook = (id: string, params: RequestParams = {}) =>
    this.request<DexQueryGetLongBookResponse, RpcStatus>({
      path: `/codchen/newchainpoc/dex/long_book/${id}`,
      method: "GET",
      format: "json",
      ...params,
    });
  ...
  queryParams = (params: RequestParams = {}) =>
    this.request<DexQueryParamsResponse, RpcStatus>({
      path: `/codchen/newchainpoc/dex/params`,
      method: "GET",
      format: "json",
      ...params,
    });
  ...
  queryShortBookAll = (
    ...
    this.request<DexQueryAllShortBookResponse, RpcStatus>({
      path: `/codchen/newchainpoc/dex/short_book`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   */
  queryShortBook = (id: string, params: RequestParams = {}) =>
    this.request<DexQueryGetShortBookResponse, RpcStatus>({
      path: `/codchen/newchainpoc/dex/short_book/${id}`,
      method: "GET",
      format: "json",
      ...params,
    });
